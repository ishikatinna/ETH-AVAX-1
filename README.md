...
4. Once the contract is deployed, you can interact with it by calling the checkValue function although we are using another nomenclature, providing a uint256 value as an argument.

5. The function will perform the following error handling operations:
